...
Version [1.0.2528.3](https://github.com/msintuneappsdk/intune-app-wrapping-tool-android/releases/).
...
> This version of the wrapping tool supports up to Android API 28.
